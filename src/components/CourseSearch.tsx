...
import { Drawer, DrawerContent, DrawerFooter, DrawerHeader, DrawerTitle, DrawerDescription } from "@/components/ui/drawer"; // Changed Dialog to Drawer
...
const CourseSearch: React.FC<CourseSearchProps> = ({ open, onOpenChange, termId, onCourseSelected }) => {
  ...
  const handleAddCourseToPlanInternal = (course: Course) => {
    ...
    // Show success message with registration info
    toast.success(`${course.code} added to cart! You can register for this course from the course registration page.`);
  };
  ...
  return (
    ...
    <Drawer open={open} onOpenChange={onOpenChange}> {/* Changed Dialog to Drawer and added direction */}
      ...
      */}
      <DrawerContent className="sm:max-w-2xl h-[90vh] flex flex-col animate-slide-in-right">
        <DrawerHeader>
        ...
        <div className="flex-grow overflow-y-auto space-y-4 p-4">
          ...
          <Tabs value={selectedTab} onValueChange={setSelectedTab} className="flex flex-col flex-grow">
            ...
            <TabsContent value="required" className="mt-4 flex-grow flex flex-col">
              ...
              <div className="space-y-3 flex-grow overflow-y-auto">
                {requiredCourses.map(course => (
                  <div
                    key={course.id}
                    className="border rounded-md p-4 flex flex-col bg-white hover:bg-gray-50 transition-colors animate-fade-in"
                  >
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex-1">
                        ...
                        <h3 className="font-medium text-base mb-2">{course.name}</h3>
                    ...
                    <div className="flex space-x-2 mt-auto">
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button variant="outline" size="sm" onClick={() => handleOpenInfoModal(course as unknown as Course)}>
                            <Info size={16} className="mr-1.5" />
                            Course Details
                          </Button>
                        </TooltipTrigger>
                        <TooltipContent>View course details and prerequisites</TooltipContent>
                      </Tooltip>
                      <Button
                        variant="default"
                        size="sm"
                ...
                {filteredCourses.map(course => (
                  ...
                  >
                    ...
                    <div className="flex space-x-2 mt-auto">
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button variant="outline" size="sm" onClick={() => handleOpenInfoModal(course)}>
                            <Info size={16} className="mr-1.5" />
                            Course Details
                          </Button>
                        </TooltipTrigger>
